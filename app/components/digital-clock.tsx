...
export default function DigitalClockComponent() {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <Card className="p-5 w-116 h-116 shadow-lg rounded-full">
        <div className="flex flex-col items-center justify-center">
            {/* Header with title */}
            <div className="text-2xl font-bold text-blue-600 mb-6 tracking-tight">
              Digital Clock
            </div>
            {/* Description */}
            <div className="text-md text-blue-500 dark:text-gray-400 mb-4">
                Display current time in hours, minutes, and seconds.
              </div>
            {/* Display the formatted time */}
            <div className="text-6xl text-blue-500 font-bold tracking-tight">
              {formattedTime}
            </div>
            {/* Buttons to switch between 24-hour and 12-hour formats */}
            <div className="mt-4 flex items-center shadow-lg">
              <Button
            ...
            <div className="mt-4 flex items-center shadow-xl">
              <Button
                variant={!is24Hour ? "default" : "outline"}
