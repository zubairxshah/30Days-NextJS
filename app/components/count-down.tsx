...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-lime-50 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-lime-200 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md shadow-xl">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-lime-800 dark:text-gray-200 text-center animate-pulse">
          Countdown Timer
        </h1>
        ...
        <div className="text-6xl font-bold text-blue-500 dark:text-gray-200 mb-8 text-center hover:animate-pulse">
          {formatTime(timeLeft)}
        </div>
