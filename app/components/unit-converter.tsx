    ...
    <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg">
      <h1 className="text-2xl font-bold mb-1 text-center">Unit Converter</h1>
        ...
        <div className="space-y-2 relative">
          ...
          <button
            type="button"
            className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-ring"
            onClick={() => {
